...
public class Caso11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_caso11);

        //las siguientes 4 lineas corresponden al GIF de la flecha izquierda
        final ImageView imageView = (ImageView) findViewById(R.id.gifIzq11);
        ...
        final ImageView imageView2 = (ImageView) findViewById(R.id.gifDer11);
    ...
    class LearnGesture extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent event1, MotionEvent event2, float velocityX, float velocityY){
            if (event2.getX() > event1.getX()){//swipe izquierda
                ...
                finish();
                Caso11.this.overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
